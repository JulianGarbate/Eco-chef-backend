...
export const buscarReceta = async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            const savedRecipes = await Promise.all(recipes.map(async (recipe) => {
                try {
                    const saved = await prisma.recipe.upsert({
                        ...
                        update: {
                            ...
                            ingredientMeasures: recipe.ingredientMeasures ? recipe.ingredientMeasures : undefined,
...
export const guardarReceta = async (req, res) => {
...
export const obtenerTodasLasRecetas = async (req, res) => {
    try {
...
export const obtenerDetalleReceta = async (req, res) => {
